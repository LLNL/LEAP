...
bool project_Joseph_cone(float*&, float*, parameters*, bool data_on_cpu);
bool project_Joseph_cone(float*&, float*, parameters*, bool data_on_cpu, bool volume_on_cpu, bool accumulate = false);
