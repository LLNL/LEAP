...
bool finiteInverseHilbert(float*& f, parameters* params, bool data_on_cpu, float scalar = 1.0, float sampleShift = 0.0);
...
bool transmissionFilter_gpu(float*& g, parameters* params, bool data_on_cpu, float* H, int N_H1, int N_H2, bool isAttenuationData, float FWHM = 1.0);
...
float smooth_rect(float x, float w=0.25, float k=20.0);
