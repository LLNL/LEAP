...
private:
    ...
    bool execute_attenuated(float* g, float* f, parameters* params, bool data_on_cpu, bool volume_on_cpu);
    ...
    bool execute_Novikov(float* g, float* f, parameters* params, bool data_on_cpu, bool volume_on_cpu);
