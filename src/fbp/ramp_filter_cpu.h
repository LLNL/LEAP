...
double rampImpulseResponse(int N, double T, int n, int rampID, bool shifted = true);
double* rampImpulseResponse(int N, double T, parameters* params);
float* rampImpulseResponse_f(int N, float T, parameters* params, bool centered = false);
