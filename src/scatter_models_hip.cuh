...
{
	hipTextureObject_t source_txt;
	hipTextureObject_t energies_txt;
	hipTextureObject_t sigma_PE_txt;
	hipTextureObject_t sigma_CS_txt;
	hipTextureObject_t sigma_RS_txt;
	hipTextureObject_t scatterDist_txt;
...
//bool firstLeg(hipTextureObject_t f_data_txt, parameters* params, float* dev_Df, float3 sourcePosition);
